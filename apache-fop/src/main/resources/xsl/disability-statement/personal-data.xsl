                ...
                <fo:table-body>
                    ...
                    <fo:table-row border-bottom="solid black 1px">
                        ...
                        <fo:table-cell>
                            <fo:block padding-bottom="0.5mm" padding-top="0.5mm">
                                <xsl:choose>
                                    <xsl:when test="fri:АктуальныеСведенияОбИнвалидности/fri:ПервичнаяИнвалидность = 'false'"><xsl:text>Повторно</xsl:text></xsl:when>
                                    <xsl:otherwise><xsl:text>Первично</xsl:text></xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                        </fo:table-cell>
                    </fo:table-row>
                    ...
                    <fo:table-row border-bottom="solid black 1px">
                        ...
                        <fo:table-cell>
                            <fo:block padding-bottom="0.5mm" padding-top="0.5mm"><xsl:value-of select="fri:АктуальныеСведенияОбИнвалидности/fri:НаименованиеПричиныИнвалидности"/></fo:block>
                        </fo:table-cell>
                    </fo:table-row>
                    <fo:table-row border-bottom="solid black 1px">
                        <fo:table-cell>
                    ...
                    <fo:table-row border-bottom="solid black 1px">
                        ...
                        <fo:table-cell>
                            ...
                            <fo:block>
                                Дата: <xsl:value-of select="fri:format-date(fri:АктуальныеСведенияОбИнвалидности/fri:ДатаАктаМСЭ)"/>
                            </fo:block>
                        </fo:table-cell>
                    </fo:table-row>
                    <fo:table-row border-bottom="solid black 1px">
                        ...
                        <fo:table-cell>
                            <fo:block padding-bottom="0.5mm" padding-top="0.5mm">
                                ...
                                <fo:block>
                                    Номер: <xsl:value-of select="fri:АктуальныеСведенияОбИнвалидности/fri:НомерСправкиМСЭ"/>
                                </fo:block>
                            </fo:block>
                        </fo:table-cell>
                    </fo:table-row>
                    <fo:table-row border-bottom="solid black 1px">
                        ...
                        <fo:table-cell>
                            <fo:block><xsl:value-of select="fri:format-date(fri:АктуальныеСведенияОбИнвалидности/fri:ДатаСправкиМСЭ)"/></fo:block>
                        </fo:table-cell>
                    </fo:table-row>
                    <fo:table-row border-bottom="solid black 1px">
                        <fo:table-cell>
                        ...
                        <fo:table-cell>
                            <fo:block padding-bottom="0.5mm" padding-top="0.5mm">
                                ...
                                <xsl:choose>
                                    <xsl:when test="$mseDublicatinfo != ''"><xsl:value-of select="$mseDublicatinfo"/></xsl:when>
